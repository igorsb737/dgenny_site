...
const Subscribe = () => {
  ...
  return (
    <section className="container mx-auto px-5 md:px-16">
      <div className="bg-primary rounded-lg text-white py-16 sm:py-24">
